...
async def voice_check(rs: RoleSession, member: discord.Member) -> None:
    ...
    await check('vc', 'in_vc', 'available_not_in_vc', 'join_vc_force', 'leave_vc_force')
    await check('vc2', 'in_vc_2', 'available_not_in_vc_2', 'join_vc_2_force', 'leave_vc_2_force', 'p')
    await check('vc3', 'in_vc_3', 'available_not_in_vc_3', 'join_vc_3_force', 'leave_vc_3_force', 'r')
